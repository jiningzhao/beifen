...
class DB:
    ...
    def db_con(self, values):
        ...
        try:
            ...
            cursor.execute('CREATE TABLE %s(id int primary key,date varchar(30),dep varchar(30),arrive varchar(30),limit varchar(30),result varchar(30))' % TABLE_NAME)
            ...
            # 批量插入数据
            cursor.executemany('INSERT INTO jining_user values(%s,%s,%s,%s,%s,%s)', values)
